...
# The contact section has custom CSS with gold colors. 
# We need to replace gold (#d4af37, #c5a880, rgba(212,175,55,...)) with the site theme (black/white)

# Replace the entire custom style block for the contact section
old_style = """<style>
...
with open('contact.html', 'w', encoding='utf-8') as f:
    f.write(html)
print("Updated contact.html to standard site theme (black & white)")
