...
# Mapping of file names to their prefix id and real title text to preserve
pages = {
    'wedding-photography.html': ('srv-wedding', 'Wedding Photography', 'Every glance, every tear, every burst of laughter — captured as it happens.', 'Our photography style blends candid storytelling with timeless portraiture. We believe the most powerful images are never posed — they\\'re stolen from real moments.'),
...
for filename, data in pages.items():
    ...
    try:
        ...
        # Regex to replace from <section class="service-dark-section" down to <!-- 2x3 Feature Grid --> <div class="row">
