...
<head>
    ...
    <style>
        ...
        input[type="text"], textarea { width: 100%; padding: 12px; background: #000; border: 1px solid #333; border-radius: 6px; color: #fff; font-family: inherit; font-size: 14px; margin-bottom: 10px; }
...
with open('views/pannl/gallery.ejs', 'w', encoding='utf-8') as f:
    f.write(clean_ejs)
print("Successfully wrote pure gallery.ejs without dependencies.")
